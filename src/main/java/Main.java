...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Contact contact1 = new Contact("John Doe", "123 475 357", "alfa@beta.gamma", "Kałasznikow");
        Contact contact2 = new Contact("Martha Steward", "123 475 357", "ms@wp.pl", "My own company");
        Contact contact3 = new Contact("George Truman", "123 475 357", "thisisverylongemail@gmail.com", "Truman Show");
